...
**Product/app thật:** workflow tìm quán qua các hình ảnh có sẵn trên Google Maps + Instagram/TikTok  
...
```text
User, đặc biệt là các user trẻ tuổi hay phân vân ở bước chọn quán cà phê để đi, vì họ biết mình thích kiểu quán nào qua hình ảnh nhưng khó diễn tả bằng từ khóa, dẫn tới phải mở nhiều app và xem từng quán thủ công trước khi chốt.
...
Owner kiểm thử path này chưa xác định.
```
